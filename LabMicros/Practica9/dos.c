...
if(cont==769){ //En ensamblador se utilizaría btfsc para verificar si el bit cambio y pasar a la subrutina que ejecuta el codigo dentro del if
printf("La conversiòn es: =%x\r",conv*0.019); //Cuando se active la interrupciòn mostrarà el valor de la conversion
cont=0;
   }
}
void main(){
